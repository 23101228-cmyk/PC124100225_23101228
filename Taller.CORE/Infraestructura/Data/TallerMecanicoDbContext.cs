...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-S9248TP4;Database=TallerMecanico;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Cliente__3214EC07C52B56CA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrdenSer__3214EC073EB1D62E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TipoServ__3214EC070E0FEB1A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Vehiculo__3214EC075C810F6E");

            entity.ToTable("Vehiculo");

            entity.HasIndex(e => e.Placa, "UQ__Vehiculo__8310F99DCC28A322").IsUnique();
